...
public class DebugFive1 {
   public static void main(String[] args) { //changed String args[] to String[] args
      ...
      if(usersChoice == 1) { //use (==) to compare
      bill = bill + LOW_PRICE;
      }
      
      System.out.println("Total bill is " + bill); //missing opening quotation mark
   }
}