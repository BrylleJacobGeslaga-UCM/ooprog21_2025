...
public class DebugSeven1 {
   public static void main(String[] args) {
      ...
      name1 = kb.nextLine(); //add ()
      System.out.print("Second name >> ");
      name2 = kb.nextLine(); //add ()
      System.out.print("Third name >> ");
      name3 = kb.nextLine(); //add ()
      compareNames(name1, name2);
      compareNames(name1, name3);
      compareNames(name2, name3);
   }
   
   public static void compareNames(String n1, String n2) { //change comparNames to compareNames and add String to n2
      System.out.print(n1 + " and " + n2);
      if(n1.equals(n2)) //add closing parenthesis
